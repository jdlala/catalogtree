...
(function ($) {
    ...
    // 11.1当时我也改了。。。
    BootstrapTable.prototype.scrollLeft = function (value) {
        if (typeof value === 'string') {
            value = value === 'right' ? this.$tableBody[0].scrollWidth : 0;
        }
        if (typeof value === 'number') {
            this.$tableBody.scrollLeft(value);
        }
        if (typeof value === 'undefined') {
            return this.$tableBody.scrollLeft();
        }
    };
    ...
    var allowedMethods = [
        ...
        'filterBy',
        'scrollTo',
        'scrollLeft',// 11.1昊哥-此处增加scrollLeft  这个我没加。。。。
        'getScrollPosition',
